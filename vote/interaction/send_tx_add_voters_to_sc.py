...
if(args.network == 'devnet'):
	...
	sc_address=Address.from_bech32("erd1qqqqqqqqqqqqqpgqludp4hayf7nl04tp2898q6wp24p07z2kmusqg2hyzl")
if(args.network == 'mainnet'):
	provider = ProxyNetworkProvider("https://gateway.multiversx.com")
	id_chain="1"
	config = DefaultTransactionBuildersConfiguration(chain_id="1")
	sc_address=Address.from_bech32("erd1qqqqqqqqqqqqqpgqcxv93atx35gag37m6rh8x89lax7gf37m92qqezwne2")

# Read the input file
data_df = pd.read_csv("final_snapshot.csv", header=None) # Header is set to None, because csv input file has no header, values start on row 1
